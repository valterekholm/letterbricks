...
/*this program was made after letter-F,,,,*/
...
void mallocInitTilesH(){
  ...
  t1->n2 = t2;//left wing, from tiles' persp.
  t2->n2 = t3;
  t3->n2 = t4;
  t4->n2 = t5;
  ...
  t11->n1 = t12;
  t12->n2 = t13;
  t13->n2 = t14; //t14 bottom right

  t11->n3 = t15;
  t15->n2 = t16;
  t16->n2 = t17; //t17 top right

  t5->n2 = t6;
  t6->n2 = t7;// t7 bottom left
  ...
  letterH.firstTile = t1;
  letterH.initialAngle = 180;//pointing down
  //TODO: maybe combine the three previous steps in one function

  if(letterH.initialAngle != 0){
    rotateRectangle(&(letterH.firstTile->r), letterH.initialAngle);
  }
}
...
int main(int argc, char **argv)
{
  ...
  if(argc == 2){
    ...
    printf("will do glutInitWindowSize");
